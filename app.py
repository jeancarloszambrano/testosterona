...
if pagina == 'Modelo':
	...
	if st.button('REALIZAR PREDIÇÃO'):
		...
		st.write('Glicemia baixa ou hipoglicemia.') if GLI < 70 st.write('Glicemia normal.') elif (GLI >= 70) and (GLI < 100) st.write('Glicemia alterada.') elif (GLI >= 100) and (GLI <= 125) 
