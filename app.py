...
if pagina == 'Modelo':
	...
	if st.button('REALIZAR PREDIÇÃO'):
		...
		st.subheader(saida)
		if pred < 0: 
			st.subheader("Predição de Diagnóstico: **NEGATIVO PARA DEFICIENCIA DE TESTOTERONA**)
		else
			st.subheader("Predição de Diagnóstico: **POSITIVO PARA DEFICIENCIA DE TESTOTERONA**)
